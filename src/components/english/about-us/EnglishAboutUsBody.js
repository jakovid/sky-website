...
export default function EnglishAboutUsBody() {
    return(
        <div id='english-about-us-body-container'>
            <div id='english-about-us-intro-container'>
                <div id='english-about-us-intro-title'>What we believe are the keys to success!</div>
                <div id='english-about-us-intro-boxes'>

                    <div className='english-about-us-intro-box'>
                        <div className='english-about-us-intro-box-title'>Small Classes</div>
                        <div className='english-about-us-intro-box-text'>
                    ...
                    <div className='english-about-us-intro-box'>
                        <div className='english-about-us-intro-box-title'>Immersive English</div>
                        <div className='english-about-us-intro-box-text'>
                    ...
                    <div className='english-about-us-intro-box'>
                        <div className='english-about-us-intro-box-title'>Strong Foundation</div>
                        <div className='english-about-us-intro-box-text'>
            ...
            <div id='english-about-us-main-container'>
                <div className="english-about-us-main-item" id='the-mission'>
                    <img className='english-about-us-main-item-image' src={ClassPic6} />
                    <div className='english-about-us-main-item-text-box'>
                        <div className='english-about-us-main-item-title green-text'>The Mission</div>
                        <div className='english-about-us-main-item-text red-text'>
                ...
                <div className="english-about-us-main-item" >
                    <div className='english-about-us-main-item-text-box'>
                        <div className='english-about-us-main-item-title red-text'>Great Teachers, <br/> Great Students</div>
                        <div className='english-about-us-main-item-text green-text'>
                    ...
                    <img className='english-about-us-main-item-image' src={ClassPic7} />
                </div>
            </div>
        </div>
    )
