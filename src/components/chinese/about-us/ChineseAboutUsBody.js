    ...
    return(
        <div id='about-us-body-container'>
            <div id='about-us-intro-container'>
                <div id='about-us-intro-title'>我們的特色</div>
                <div id='about-us-intro-boxes'>
                    ...
                    <div className='about-us-intro-box'>
                        <div className='about-us-intro-box-title'>沉浸式英語</div>
                        <div className='about-us-intro-box-text'>
                    ...
                    <div className='about-us-intro-box'>
                        <div className='about-us-intro-box-title'>堅實的基礎</div>
                        <div className='about-us-intro-box-text'>
            ...
            <div id='about-us-main-container'>
                <div className="about-us-main-item" id='the-mission'>
                    ...
                    <div className='about-us-main-item-text-box'>
                        <div className='about-us-main-item-title green-text'>核心理念</div>
                ...
                <div className="about-us-main-item" >
                    <div className='about-us-main-item-text-box'>
                        <div className='about-us-main-item-title red-text'>熱忱的老師<br/>優秀學生</div>
